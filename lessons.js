...
const OPENINGS=[
  ...
  { name:"Bishop's Opening", video:{ id:"wgeshBzJNh0", title:"Modern Bishop's Opening | Italian Game Theory", author:"Hanging Pawns", length:"26 min" }, eco:"C24", side:"w", cat:"1. e4 — King's Pawn",
  ...
  { name:"From's Gambit", video:{ id:"4fXvAdX8pqo", title:"From's Gambit", author:"Hanging Pawns", length:"32 min" }, eco:"A02", side:"b", cat:"⚔️ Gambits — as Black",
  ...
  { name:"Blackmar-Diemer Gambit", video:{ id:"4IwxHPouUJQ", title:"The Blackmar-Diemer Gambit | Chess Openings", author:"Hanging Pawns", length:"34 min" }, eco:"D00", side:"w", cat:"⚔️ Gambits — as White",
  ...
  { name:"French: Tarrasch (3.Nd2)", video:{ id:"IGS68T5FmvM", title:"Tarrasch Variation of the French Defense (C03-C09)", author:"Hanging Pawns", length:"31 min" }, eco:"C03", side:"b", cat:"Defenses to 1. e4",
  ...
  { name:"Colle System", video:{ id:"FN7xJhjCxkY", title:"The Colle System: Plans, Structures, Patterns, Variations", author:"Hanging Pawns", length:"51 min" }, eco:"D05", side:"w", cat:"1. d4 — Queen's Pawn",
  ...
  { name:"Torre Attack", video:{ id:"xbUgaJGb5Ps", title:"The Torre Attack: Plans, Structures, Patterns, Variations", author:"Hanging Pawns", length:"55 min" }, eco:"A46", side:"w", cat:"1. d4 — Queen's Pawn",
  ...
  { name:"Tarrasch Defense", video:{ id:"esjT83wWr78", title:"Tarrasch Defense Opening Theory", author:"Hanging Pawns", length:"27 min" }, eco:"D32", side:"b", cat:"Defenses to 1. d4",
...
const ENDGAMES=[
  ...
  { name:"Queen vs Pawn (on the 7th)", video:{ id:"Ji8NjJknEjY", title:"Queen vs Pawn Endgames", author:"Hanging Pawns", length:"17 min" }, eco:"Q v P", side:"w", cat:"♚ Endgames & Theory",
  ...
  { name:"Bishop & Knight Mate", video:{ id:"oX_pq-2kiJI", title:"Knight and Bishop Checkmate | Chess Endgames", author:"Hanging Pawns", length:"30 min" }, eco:"B+N#", side:"w", cat:"♚ Endgames & Theory",
...
const MORE=[
  ...
  { name:"Vienna Gambit", video:{ id:"NKeSyWouCPc", title:"The Vienna Gambit: Ideas, Patterns, Traps and all Variations", author:"Hanging Pawns", length:"30 min" }, eco:"C29", side:"w", cat:"⚔️ Gambits — as White",
  ...
  { name:"Chigorin Defense", video:{ id:"CASr3pqMjYk", title:"Introduction to the Chigorin Defense", author:"Hanging Pawns", length:"19 min" }, eco:"D07", side:"b", cat:"Defenses to 1. d4",
  ...
  { name:"Nimzowitsch Defense", video:{ id:"fqQHlOCFmW8", title:"Nimzowitsch Defense Opening Theory", author:"Hanging Pawns", length:"38 min" }, eco:"B00", side:"b", cat:"Defenses to 1. e4",
  ...
  { name:"Richter-Veresov Attack", video:{ id:"Q8vB7eWjDaY", title:"The Richter-Veresov Attack: Plans, Structures, Patterns, Variations", author:"Hanging Pawns", length:"58 min" }, eco:"D01", side:"w", cat:"1. d4 — Queen's Pawn",
  ...
  { name:"Berlin Defense", video:{ id:"PB9H-qtSsUM", title:"Berlin Defense | Complete Chess Openings", author:"Hanging Pawns", length:"65 min" }, eco:"C65", side:"w", cat:"1. e4 — King's Pawn",
  ...
  { name:"Taimanov Sicilian", video:{ id:"urpEN-6XDoY", title:"Taimanov Sicilian: Basics, Strategy, Theory, Transpositions", author:"Hanging Pawns", length:"65 min" }, eco:"B46", side:"b", cat:"Defenses to 1. e4",
  ...
  { name:"Kan Sicilian", video:{ id:"9CxgfDX44Ug", title:"Sicilian Kan | Chess Openings", author:"Hanging Pawns", length:"29 min" }, eco:"B42", side:"b", cat:"Defenses to 1. e4",
  ...
  { name:"Moscow Variation", video:{ id:"vwQVr9bHmXk", title:"Moscow Variation | Sicilian Defense Theory", author:"Hanging Pawns", length:"30 min" }, eco:"B52", side:"w", cat:"1. e4 — King's Pawn",
  ...
  { name:"Caro-Kann: Advance", video:{ id:"m9uHKJ1WgbM", title:"Caro-Kann Defense: Advance Variation in Depth", author:"Hanging Pawns", length:"20 min" }, eco:"B12", side:"b", cat:"Defenses to 1. e4",
  ...
  { name:"Caro-Kann: Panov Attack", video:{ id:"RUBEZ95_BiQ", title:"Caro-Kann, Panov-Botvinnik Attack | Complete Chess Openings", author:"Hanging Pawns", length:"75 min" }, eco:"B13", side:"b", cat:"Defenses to 1. e4",
  ...
  { name:"French: Winawer", video:{ id:"NWFL6b38BUQ", title:"Winawer Variation of the French Defense (C15-C19)", author:"Hanging Pawns", length:"23 min" }, eco:"C15", side:"b", cat:"Defenses to 1. e4",
  ...
  { name:"French: Advance", video:{ id:"plgs6rbCMjE", title:"Advance Variation of the French Defense (C02)", author:"Hanging Pawns", length:"23 min" }, eco:"C02", side:"b", cat:"Defenses to 1. e4",
  ...
  { name:"Modern Benoni", video:{ id:"x0TDJK973ms", title:"Introduction to the Benoni Defense", author:"Hanging Pawns", length:"17 min" }, eco:"A60", side:"b", cat:"Defenses to 1. d4",
  ...
  { name:"Bird's Opening", video:{ id:"wtTk2pd1xlk", title:"Bird Opening: Ideas, Structures, Principles, Theory, Transpositions", author:"Hanging Pawns", length:"41 min" }, eco:"A02", side:"w", cat:"Flank Openings",
  ...
  { name:"Nimzo-Larsen Attack", video:{ id:"lnMg7otrVpE", title:"The Nimzo-Larsen Attack: Ideas, Principles, Plans, Variations", author:"Hanging Pawns", length:"61 min" }, eco:"A01", side:"w", cat:"Flank Openings",
  ...
  {name:"Caro-Kann: Classical", video:{ id:"OiMf511N_xc", title:"Caro-Kann, Classical Variation (Bf5) | Complete Chess Openings", author:"Hanging Pawns", length:"54 min" },eco:"B18",side:"b",cat:"Defenses to 1. e4",
  ...
  {name:"French: Rubinstein", video:{ id:"THkLmg9vmv0", title:"Rubinstein Variation of the French Defense (C10)", author:"Hanging Pawns", length:"14 min" },eco:"C10",side:"b",cat:"Defenses to 1. e4",
  ...
  {name:"French: Exchange", video:{ id:"YlA3heOMMN0", title:"Exchange Variation of the French Defense (C01)", author:"Hanging Pawns", length:"18 min" },eco:"C01",side:"b",cat:"Defenses to 1. e4",
  ...
  {name:"Albin Counter-Gambit", video:{ id:"drRFTPODZlA", title:"The Albin Counter-Gambit | Chess Openings", author:"Hanging Pawns", length:"25 min" },eco:"D08",side:"b",cat:"⚔️ Gambits — as Black",
  ...
  {name:"Hippopotamus Defense", video:{ id:"656d__sO3XM", title:"The Hippo: Plans, Patterns and Ideas in the Hippopotamus Opening", author:"Hanging Pawns", length:"28 min" },eco:"B00",side:"b",cat:"Defenses to 1. e4",
  ...
  {name:"King's Gambit: Bishop's Gambit", video:{ id:"eN-NroFECXo", title:"Bishop's Gambit | King's Gambit Opening Theory", author:"Hanging Pawns", length:"27 min" },eco:"C33",side:"w",cat:"⚔️ Gambits — as White",
  ...
  {name:"Two Knights Defense", video:{ id:"rKoZkrBWDbU", title:"The Knight Attack (4.Ng5) | Italian Game Theory", author:"Hanging Pawns", length:"32 min" },eco:"C57",side:"b",cat:"Defenses to 1. e4",
  ...
  {name:"Petroff (Russian) Defense", video:{ id:"KrGPeutGfaQ", title:"Petrov Defense Classical Variation (main line)", author:"Hanging Pawns", length:"29 min" },eco:"C42",side:"b",cat:"Defenses to 1. e4",
  ...
  {name:"Leningrad Dutch", video:{ id:"FE1dYi-c1kU", title:"The Leningrad Dutch | Chess Openings", author:"Hanging Pawns", length:"55 min" },eco:"A88",side:"b",cat:"Defenses to 1. d4",
  ...
  {name:"Pirc: Austrian Attack", video:{ id:"7W2dB74VcUQ", title:"The Austrian Attack | Pirc Defense Opening Theory", author:"Hanging Pawns", length:"23 min" },eco:"B09",side:"b",cat:"Defenses to 1. e4",
