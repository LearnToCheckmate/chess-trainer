...
T=[
 ...
 ("polish","Base shell for every board screen","part","#344","Agreed with Kunal: back arrow and dots, player bar, board full width, player bar, one context line, one row of controls, bars absorbing the slack. BUILT on the review screen (gaps 4px top, 8px bottom, board 424 of 430). STILL TO ROLL: play, lessons, puzzles - all three still lose 8px to a legacy reserve and still show the empty band Kunal flagged."),
