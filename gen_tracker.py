...
STAMP = "Updated through build #135 - 2026-06-10"
...
TASKS = [
    ...
    {"g": "play", "id": "pl-btnalign","s": "open", "t": "Tidy bottom button sizing + font alignment (Play)", "n": "Feedback (2026-06-08): fix the button sizes and font alignment along the bottom of the Play vs Computer screen."},
