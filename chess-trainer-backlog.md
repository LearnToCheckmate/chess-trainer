# ACTIVE QUEUE - reconciled 2026-06-19 (app at build #232)
...
- [ ] DECIDE (Kunal, 2026-06-20): in learn mode the header now shows the lesson/gambit/ending name AND there is still a larger duplicate title below it. Keep the larger title, or drop it to reclaim vertical space?
...
## RECENTLY SHIPPED
#232 LIBRARY +4 common openings that were genuine gaps (all engine-verified, audit PASS): Petroff / Russian Defense (C42), Closed Sicilian (B25), Ruy Lopez Steinitz Defense (C62), Leningrad Dutch (A88). Checked the library against ~45 common openings first; these were the clear missing ones a beginner would expect.
