# ACTIVE QUEUE - reconciled 2026-06-19 (app at build #221)
...
- [ ] Library expansion (BUILD THEM ALL, in progress): 36 shipped (batches 1-3, #220-#221). Still to build: Cambridge Springs, Exchange QGD, Budapest main, Blumenfeld, Modern + Czech Benoni, flank (Bird, Nimzo-Larsen, Sokolsky, Grob, Hippo), King's Gambit branches (Muzio/Kieseritzky/Allgaier/Cunningham), Scandinavian gambits (Portuguese/Icelandic), Albin main, St. George, Hungarian, Three Knights, Classical Sicilian + assorted offbeat lines. [CLAUDE]
